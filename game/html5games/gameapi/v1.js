    ...
    ! function(a, b) {
        var famobi = {
                    ...
                    return new Promise(function(resolve, reject) {
                        ...
                        function readTextFile(file, callback) {
                            function useInlineConfig() {
                                if (window.FAMOBI_INLINE_CONFIG) {
                                    callback(JSON.stringify(window.FAMOBI_INLINE_CONFIG));
                                    return true;
                                }
                                return false;
                            }
                            if (document.location.protocol === "file:" && useInlineConfig()) {
                                return;
                            }
                ...
                rewardedAd: function(callback) {
                    var result = Object.assign({}, this.rewardedads.defaultReturnValue, {
                        adDidLoad: true,
                        adDidShow: false,
                        rewardGranted: true
                    });
            ...
            setTimeout(function() {
                (function next() {
                    ...
                    if (typeof currentScript === "function") {
                        ...
                        scriptEl.src = _currentScript
                            ? window.famobi.__(_currentScript[2])
                            : window.famobi.getAbsolutePath(currentScript);
